...
typeorm_1.createConnection().then(function (connection) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, connection.manager.save(banque)];
            case 2:
                _a.sent();
            ...
            case 3:
                users = _a.sent();
                return [4 /*yield*/, connection.manager.find(Banque_1.Banque)];
            case 4:
                banques = _a.sent();
                console.log("Loaded users: ", users);
                console.log("Loaded users: ", banques);
